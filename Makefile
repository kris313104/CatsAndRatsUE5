...
GAMEPROJECTFILE =/home/megamarchewa/Documents/Unreal Projects/CatsAndRats2D/CatsAndRats2D.uproject

TARGETS = \
	CatsAndRats2D-Linux-Debug  \
	CatsAndRats2D-Linux-DebugGame  \
	CatsAndRats2D-Linux-Test  \
	CatsAndRats2D-Linux-Shipping  \
	CatsAndRats2D \
	CatsAndRats2DEditor-Linux-Debug  \
	CatsAndRats2DEditor-Linux-DebugGame  \
	CatsAndRats2DEditor-Linux-Test  \
	CatsAndRats2DEditor-Linux-Shipping  \
	CatsAndRats2DEditor \
...
StandardSet: RequiredTools UnrealFrontend CatsAndRats2DEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug CatsAndRats2DEditor-Linux-Debug


CatsAndRats2D-Linux-Debug:
	 $(PROJECTBUILD) CatsAndRats2D Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2D-Linux-DebugGame:
	 $(PROJECTBUILD) CatsAndRats2D Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2D-Linux-Test:
	 $(PROJECTBUILD) CatsAndRats2D Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2D-Linux-Shipping:
	 $(PROJECTBUILD) CatsAndRats2D Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2D:
	 $(PROJECTBUILD) CatsAndRats2D Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2DEditor-Linux-Debug:
	 $(PROJECTBUILD) CatsAndRats2DEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2DEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CatsAndRats2DEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2DEditor-Linux-Test:
	 $(PROJECTBUILD) CatsAndRats2DEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2DEditor-Linux-Shipping:
	 $(PROJECTBUILD) CatsAndRats2DEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CatsAndRats2DEditor:
	 $(PROJECTBUILD) CatsAndRats2DEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
